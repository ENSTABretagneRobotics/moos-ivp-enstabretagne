...
Rad2Degree *objRad2Degree;

void kill_handler(int s);

int main(int argc, char *argv[])
{
  objRad2Degree = new Rad2Degree;
  ...
  cout << "pRad2Degree launching as " << run_command << endl;
  cout << termColor() << endl;
  ...
  objRad2Degree->Run(run_command.c_str(), mission_file.c_str());
