...
SeaNetMsg::SeaNetMsg():m_destinationNode(0x02)
{
}

SeaNetMsg::SeaNetMsg(const char &destinationNode)
:m_destinationNode(destinationNode)
{
}

SeaNetMsg::SeaNetMsg(const std::string &data, const char &destinationNode)
: m_data(data), m_destinationNode(destinationNode)
{
}

SeaNetMsg::SeaNetMsg(const std::string &data)
: m_data(data), m_destinationNode(0x02)
{
}
