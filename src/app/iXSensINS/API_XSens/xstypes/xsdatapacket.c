...
void XsDataPacket_swap(XsDataPacket* a, XsDataPacket* b)
{
	...
	tint = b->m_lastFoundOffset;
	b->m_lastFoundOffset = a->m_lastFoundOffset;
	a->m_lastFoundOffset = tint;
...
XsUShortVector* XsDataPacket_rawAcceleration(const XsDataPacket* thisPtr, XsUShortVector* returnVal)
{
	...
	itemOffset = XsDataPacket_itemOffsetExact(thisPtr, XDI_RawAccGyrMagTemp);
	if (itemOffset == -1)
		itemOffset = XsDataPacket_itemOffsetExact(thisPtr, XDI_RawAcc);

	if (itemOffset != -1)
	{
		for (i=0 ; i<3 ; ++i)
			returnVal->m_data[i] = XsMessage_getDataShort(&thisPtr->m_msg, itemOffset + (2*i));
	}
...
int XsDataPacket_containsRawAcceleration(const XsDataPacket* thisPtr)
{
	return (XsDataPacket_itemOffsetExact(thisPtr, XDI_RawAccGyrMagTemp) != -1) ||
		(XsDataPacket_itemOffsetExact(thisPtr, XDI_RawAcc) != -1);
}
...
XsUShortVector* XsDataPacket_rawGyroscopeData(const XsDataPacket* thisPtr, XsUShortVector* returnVal)
{
	...
	if (itemOffset != -1)
		...
		itemOffset = XsDataPacket_itemOffsetExact(thisPtr, XDI_RawGyr);
...
{
	return (XsDataPacket_itemOffsetExact(thisPtr, XDI_RawAccGyrMagTemp) != -1) ||
		(XsDataPacket_itemOffsetExact(thisPtr, XDI_RawGyr) != -1);
}
...
XsUShortVector* XsDataPacket_rawMagneticField(const XsDataPacket* thisPtr, XsUShortVector* returnVal)
{
	...
	if (itemOffset != -1)
		...
		itemOffset = XsDataPacket_itemOffsetExact(thisPtr, XDI_RawMag);
...
{
	return (XsDataPacket_itemOffsetExact(thisPtr, XDI_RawAccGyrMagTemp) != -1) ||
		(XsDataPacket_itemOffsetExact(thisPtr, XDI_RawMag) != -1);
}
...
XsVector* XsDataPacket_calibratedAcceleration(const XsDataPacket* thisPtr, XsVector* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_Acceleration);
...
XsVector* XsDataPacket_calibratedGyroscopeData(const XsDataPacket* thisPtr, XsVector* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_RateOfTurn);
		XsVector_assign(returnVal, 3, 0);
		XsMessage_getDataFPValuesById(&thisPtr->m_msg, thisPtr->m_lastFoundId, &returnVal->m_data[0], offset, 3);
		return returnVal;
	}
...
XsVector* XsDataPacket_calibratedMagneticField(const XsDataPacket* thisPtr, XsVector* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_MagneticField);
		XsVector_assign(returnVal, 3, 0);
		XsMessage_getDataFPValuesById(&thisPtr->m_msg, thisPtr->m_lastFoundId, &returnVal->m_data[0], offset, 3);
		return returnVal;
	}
...
XsQuaternion* XsDataPacket_orientationQuaternion(const XsDataPacket* thisPtr, XsQuaternion* returnVal, XsDataIdentifier coordinateSystem)
{
	...
	{
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_Quaternion);
...
XsEuler* XsDataPacket_orientationEuler(const XsDataPacket* thisPtr, XsEuler* returnVal, XsDataIdentifier coordinateSystem)
{
	...
	{
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_EulerAngles);
		XsDataIdentifier foundCsys = (XsDataIdentifier) XsMessage_getDataShort(&thisPtr->m_msg, offset-3);
...
XsMatrix* XsDataPacket_orientationMatrix(const XsDataPacket* thisPtr, XsMatrix* returnVal, XsDataIdentifier coordinateSystem)
{
	...
	if (XsDataPacket_containsOrientationMatrix(thisPtr))
	{
		...
		int i, j;
		uint16_t k = 0;
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_RotationMatrix);
		XsDataIdentifier foundCsys = (XsDataIdentifier) XsMessage_getDataShort(&thisPtr->m_msg, offset-3);
...
XsGpsPvtData* XsDataPacket_gpsPvtData(const XsDataPacket* thisPtr, XsGpsPvtData* returnVal)
{
	...
	if (XsDataPacket_containsGpsPvtData(thisPtr))
	{
		...
		for (i = 0; i < 3; i++)
			bareln[i] = XsMessage_getDataLong(&thisPtr->m_msg, XsDataPacket_itemOffsetExact(thisPtr, XDI_GpsSol) + (4*i) + 12);

		bareln = (uint32_t*)&returnVal->m_veln;
		for (i = 0; i < 3; i++)
			bareln[i] = XsMessage_getDataLong(&thisPtr->m_msg, XsDataPacket_itemOffsetExact(thisPtr, XDI_GpsSol) + (4*i) + 28);

		bareln = (uint32_t*)&returnVal->m_hacc;
		for (i = 0; i < 3; i++)
			bareln[i] = XsMessage_getDataLong(&thisPtr->m_msg, XsDataPacket_itemOffsetExact(thisPtr, XDI_GpsSol) + 24);
...
XsSdiData* XsDataPacket_sdiData(const XsDataPacket* thisPtr, XsSdiData* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_DeltaQ);
...
/*! \relates XsDataPacket
	...
	\param returnVal an XsDeviceId object to put the requested in

	\returns An XsDeviceId object containing the pressure and if available the pressure age
*/
XsDeviceId* XsDataPacket_storedDeviceId(const XsDataPacket* thisPtr, XsDeviceId* returnVal)
{
	assert(returnVal);
	if (XsDataPacket_containsStoredDeviceId(thisPtr))
	{
		returnVal->m_deviceId = XsMessage_getDataLong(&thisPtr->m_msg, XsDataPacket_itemOffsetExact(thisPtr, XDI_DeviceId));
	}
	return returnVal;
}
...
*/
int XsDataPacket_containsStoredDeviceId(XsDataPacket const* thisPtr)
{
	return (XsDataPacket_itemOffsetExact(thisPtr, XDI_DeviceId) != -1);
}
...
void XsDataPacket_setStoredDeviceId(XsDataPacket* thisPtr, const XsDeviceId* data)
{
	if (!XsDataPacket_containsStoredDeviceId(thisPtr))
	{
		// add
		XsSize sz = XsMessage_dataSize(&thisPtr->m_msg);
		XsMessage_resizeData(&thisPtr->m_msg, sz+7);

		XsMessage_setDataShort(&thisPtr->m_msg, XDI_DeviceId, sz);
		XsMessage_setDataByte(&thisPtr->m_msg, 4, sz+2);
		thisPtr->m_itemCount++;
	}
	// update
	XsMessage_setDataLong(&thisPtr->m_msg, data->m_deviceId, XsDataPacket_itemOffsetExact(thisPtr, XDI_DeviceId));
}
...
{
	double rv = XsMath_infinity;
	int offsetA = XsDataPacket_itemOffsetLoose(thisPtr, XDI_AltitudeMsl);
...
{
	return	XsDataPacket_itemOffsetLoose(thisPtr, XDI_AltitudeMsl) != -1;
}
...
{
	uint8_t ds = XsDataPacket_getFPValueSize(XDI_SubFormatDouble);
	if (XsDataPacket_itemOffsetExact(thisPtr, XDI_AltitudeMsl | XDI_SubFormatDouble) == -1)
	{
		// add
		XsSize sz = XsMessage_dataSize(&thisPtr->m_msg);
		XsMessage_resizeData(&thisPtr->m_msg, sz+3+ds);

		XsMessage_setDataShort(&thisPtr->m_msg, XDI_AltitudeMsl | XDI_SubFormatDouble, sz);
		XsMessage_setDataByte(&thisPtr->m_msg, ds, sz+2);
		++thisPtr->m_itemCount;
	}
	// update
	XsMessage_setDataFPValuesById(&thisPtr->m_msg, XDI_SubFormatDouble, &data, XsDataPacket_itemOffsetExact(thisPtr, XDI_AltitudeMsl | XDI_SubFormatDouble), 1);
}
...
XsVector* XsDataPacket_velocity(const XsDataPacket* thisPtr, XsVector* returnVal, XsDataIdentifier coordinateSystem)
{
	...
	if (XsDataPacket_containsVelocity(thisPtr))
	{
		...
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_VelocityXYZ);
		XsDataIdentifier foundCsys = (XsDataIdentifier) XsMessage_getDataShort(&thisPtr->m_msg, offset-3);
...
XsVector* XsDataPacket_freeAcceleration(const XsDataPacket* thisPtr, XsVector* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetLoose(thisPtr, XDI_FreeAcceleration);
		XsVector_assign(returnVal, 3, 0);
		XsMessage_getDataFPValuesById(&thisPtr->m_msg, thisPtr->m_lastFoundId, &returnVal->m_data[0], offset, 3);
	}
	else
...
XsRange* XsDataPacket_frameRange(const XsDataPacket* thisPtr, XsRange* returnVal)
{
	...
	if (XsDataPacket_containsFrameRange(thisPtr))
	{
		...
		uint16_t first = XsMessage_getDataShort(&thisPtr->m_msg, offset);
		uint16_t last = XsMessage_getDataShort(&thisPtr->m_msg, offset + 2);

		returnVal->m_first = first;
		returnVal->m_last = (int)((uint16_t)(last - first)) + (int)first;
	}
	else
	{
		returnVal->m_first = 0;
...
void XsDataPacket_setFrameRange(XsDataPacket* thisPtr, const XsRange* r)
{
	...
	// update
	//lint --e{647}
	XsMessage_setDataShort(&thisPtr->m_msg, (uint16_t) r->m_first, offset);
	XsMessage_setDataShort(&thisPtr->m_msg, (uint16_t) r->m_last, offset + 2);
}
...
XsRawGpsDop* XsDataPacket_rawGpsDop(const XsDataPacket* thisPtr, XsRawGpsDop* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetExact(thisPtr, XDI_GpsDop);
...
XsRawGpsSol* XsDataPacket_rawGpsSol(const XsDataPacket* thisPtr, XsRawGpsSol* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetExact(thisPtr, XDI_GpsSol);
		returnVal->m_itow = XsMessage_getDataLong(&thisPtr->m_msg, offset);
...
XsRawGpsTimeUtc* XsDataPacket_rawGpsTimeUtc(const XsDataPacket* thisPtr, XsRawGpsTimeUtc* returnVal)
{
	...
	{
		int offset = XsDataPacket_itemOffsetExact(thisPtr, XDI_GpsTimeUtc);
		returnVal->m_itow = XsMessage_getDataLong(&thisPtr->m_msg, offset);
...
XsRawGpsSvInfo* XsDataPacket_rawGpsSvInfo(const XsDataPacket* thisPtr, XsRawGpsSvInfo* returnVal)
{
	...
	{
		XsSize i;
		int offset = XsDataPacket_itemOffsetExact(thisPtr, XDI_GpsSvInfo);
...
{
	if (XsDataPacket_containsRawGnssPvtData(thisPtr))
	{
		int offset = XsDataPacket_itemOffsetExact(thisPtr, XDI_GnssPvtData);
		returnVal->m_itow = XsMessage_getDataLong(&thisPtr->m_msg, offset + 0);
		returnVal->m_year = XsMessage_getDataShort(&thisPtr->m_msg, offset + 4);
		returnVal->m_month = XsMessage_getDataByte(&thisPtr->m_msg, offset + 6);
		returnVal->m_day = XsMessage_getDataByte(&thisPtr->m_msg, offset + 7);
		returnVal->m_hour = XsMessage_getDataByte(&thisPtr->m_msg, offset + 8);
		returnVal->m_min = XsMessage_getDataByte(&thisPtr->m_msg, offset + 9);
		returnVal->m_sec = XsMessage_getDataByte(&thisPtr->m_msg, offset + 10);
		returnVal->m_valid = XsMessage_getDataByte(&thisPtr->m_msg, offset + 11);
		returnVal->m_tAcc = XsMessage_getDataLong(&thisPtr->m_msg, offset + 12);
		returnVal->m_nano = XsMessage_getDataLong(&thisPtr->m_msg, offset + 16);
		returnVal->m_fixType = XsMessage_getDataByte(&thisPtr->m_msg, offset + 20);
		returnVal->m_flags = XsMessage_getDataByte(&thisPtr->m_msg, offset + 21);
		returnVal->m_numSv = XsMessage_getDataByte(&thisPtr->m_msg, offset + 22);
		returnVal->m_res1 = XsMessage_getDataByte(&thisPtr->m_msg, offset + 23);
		returnVal->m_lon = XsMessage_getDataLong(&thisPtr->m_msg, offset + 24);
		returnVal->m_lat = XsMessage_getDataLong(&thisPtr->m_msg, offset + 28);
		returnVal->m_height = XsMessage_getDataLong(&thisPtr->m_msg, offset + 32);
		returnVal->m_hMsl = XsMessage_getDataLong(&thisPtr->m_msg, offset + 36);
		returnVal->m_hAcc = XsMessage_getDataLong(&thisPtr->m_msg, offset + 40);
		returnVal->m_vAcc = XsMessage_getDataLong(&thisPtr->m_msg, offset + 44);
		returnVal->m_velN = XsMessage_getDataLong(&thisPtr->m_msg, offset + 48);
		returnVal->m_velE = XsMessage_getDataLong(&thisPtr->m_msg, offset + 52);
		returnVal->m_velD = XsMessage_getDataLong(&thisPtr->m_msg, offset + 56);
		returnVal->m_gSpeed = XsMessage_getDataLong(&thisPtr->m_msg, offset + 60);
		returnVal->m_headMot = XsMessage_getDataLong(&thisPtr->m_msg, offset + 64);
		returnVal->m_sAcc = XsMessage_getDataLong(&thisPtr->m_msg, offset + 68);
		returnVal->m_headAcc = XsMessage_getDataLong(&thisPtr->m_msg, offset + 72);
		returnVal->m_headVeh = XsMessage_getDataLong(&thisPtr->m_msg, offset + 76);
		returnVal->m_gdop = XsMessage_getDataShort(&thisPtr->m_msg, offset + 80);
		returnVal->m_pdop = XsMessage_getDataShort(&thisPtr->m_msg, offset + 82);
		returnVal->m_tdop = XsMessage_getDataShort(&thisPtr->m_msg, offset + 84);
		returnVal->m_vdop = XsMessage_getDataShort(&thisPtr->m_msg, offset + 86);
		returnVal->m_hdop = XsMessage_getDataShort(&thisPtr->m_msg, offset + 88);
		returnVal->m_ndop = XsMessage_getDataShort(&thisPtr->m_msg, offset + 90);
		returnVal->m_edop = XsMessage_getDataShort(&thisPtr->m_msg, offset + 92);

	} else
	{
		memset(returnVal, 0, sizeof(XsRawGnssPvtData));
	}
...
{
	return (XsDataPacket_itemOffsetExact(thisPtr, XDI_GnssPvtData) != -1);
}
...
XsRawGnssSatInfo* XsDataPacket_rawGnssSatInfo(const XsDataPacket* thisPtr, XsRawGnssSatInfo* returnVal)
{
	...
	{
		XsSize i;
		int offset = XsDataPacket_itemOffsetExact(thisPtr, XDI_GnssSatInfo);

		returnVal->m_itow = XsMessage_getDataLong(&thisPtr->m_msg, offset + 0);
		returnVal->m_numSvs = XsMessage_getDataByte(&thisPtr->m_msg, offset + 4);
		returnVal->m_res1 = XsMessage_getDataByte(&thisPtr->m_msg, offset + 5);
		returnVal->m_res2 = XsMessage_getDataByte(&thisPtr->m_msg, offset + 6);
		returnVal->m_res3 = XsMessage_getDataByte(&thisPtr->m_msg, offset + 7);

		offset = offset + 8;
		for (i = 0; i < returnVal->m_numSvs; i++)
		{
			returnVal->m_satInfos[i].m_gnssId = XsMessage_getDataByte(&thisPtr->m_msg, offset + 0);
			returnVal->m_satInfos[i].m_svId = XsMessage_getDataByte(&thisPtr->m_msg, offset + 1);
			returnVal->m_satInfos[i].m_cno = XsMessage_getDataByte(&thisPtr->m_msg, offset + 2);
			returnVal->m_satInfos[i].m_flags = XsMessage_getDataByte(&thisPtr->m_msg, offset + 3);
			offset += 4;
		}
	}
	...
	{
		memset(returnVal, 0, sizeof(XsRawGnssSatInfo));
	}
...
{
	return (XsDataPacket_itemOffsetExact(thisPtr, XDI_GnssSatInfo) != -1);
}
