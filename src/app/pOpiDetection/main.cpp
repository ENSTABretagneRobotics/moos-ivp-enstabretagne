...
OpiDetection *objOpiDetection;

void kill_handler(int s);

int main(int argc, char *argv[])
{
  objOpiDetection = new OpiDetection;
  ...
  cout << "pOpiDetection launching as " << run_command << endl;
  cout << termColor() << endl;
  ...
  objOpiDetection->Run(run_command.c_str(), mission_file.c_str());
