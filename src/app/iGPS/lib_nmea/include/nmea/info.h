...
typedef struct _nmeaINFO {
	...
	float mtrack;					/**< Magnetic Track angle in degrees True */
	float magvar;					/**< Magnetic variation degrees */

	int rti_utc;					/**< UTC of sample */
	int rti_sample_nb;				/**< Sample number */
	int rti_temp;					/**< Temperature in hundreds of degrees Celsius. Measured at the transducer*/
	int rti_bottom_vx;			/**< Bottom track X velocity component mm/s. -99999 indicates no valid velocity*/
	int rti_bottom_vy;			/**< Bottom track Y velocity component mm/s. -99999 indicates no valid velocity*/
	int rti_bottom_vz;			/**< Bottom track Z velocity component mm/s. -99999 indicates no valid velocity*/
	int rti_bottom_depth;			/**< Depth below transducer in mm. Range to the bottom, 0 = no detection*/
	int rti_water_vx;				/**< Water mass X velocity component mm/s. -99999 indicates no valid velocity*/
	int rti_water_vy;				/**< Water mass Y velocity component mm/s. -99999 indicates no valid velocity*/
	int rti_water_vz;				/**< Water mass Z velocity component mm/s. -99999 indicates no valid velocity*/
	int rti_water_depth;			/**< Depth of water mass measurement in mm. Position of bin in front of the transducer*/
	char rti_cbit[4];				/**< Built in test and status bits in hexadecimal0000 = OK*/
	int rti_S;						/**< Sub System*/
	int rti_N;						/**< Sub System index*/
